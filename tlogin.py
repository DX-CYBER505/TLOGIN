...
echo  "${yellow}               Created by DX CYBER BOY "
...
line
echo ""
printf "${red}YouTube ${blue}https://youtube.com/@dxcyberboy1056${reset}\n"
printf "${red}Website ${blue}https://www.facebook.com/Darkcyber6${reset}\n"
printf "${red}Instgram ${blue}https://www.instagram.com/dark_lover/${reset}\n"
line
echo ""
line